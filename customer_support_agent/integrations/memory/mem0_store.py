...
class CustomerMemoryStore:
    ...
    def __init__(self, settings:Settings, llm:Any):
        ...
        _ = llm
        self._disable_chroma_keyword_preprocessing()
    ...
    @staticmethod
    def _disable_chroma_keyword_preprocessing() -> None:
        """
        Mem0 runs BM25/entity preprocessing before discovering that Chroma only
        supports semantic search. Avoid lazy spaCy model downloads on request.
        """
        try:
        ...
        mem0_main.lemmatize_for_bm25 = lambda text: text
        mem0_main.extract_entities = lambda text: []
    ...
    def _add_messages(
        ...
        try:
            ...
            # Older mem0 versions may not support infer.
